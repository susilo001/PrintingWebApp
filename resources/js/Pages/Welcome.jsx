  ...
  return (
    <AuthenticatedLayout>
      ...
      <div className="container mx-auto my-12 max-w-7xl space-y-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid h-full justify-items-center gap-4 sm:grid-cols-3">
          <div className="flex flex-col">
            ...
            <div className="grow sm:border-r sm:border-primary-focus">
          ...
          <div className="col-span-2">
            ...
            <div
              className="grid gap-6 overflow-hidden overflow-y-auto pr-4 sm:grid-cols-2 sm:scroll-smooth"
              style={{
                height: "920px",
              }}
            >
              {products.map((product, index) => (
                ...
                >
                  <Card className="card-compact h-72 w-96 border shadow-lg hover:bg-base-200">
                    <Card.Image
                      src={product.images[0]}
                      className={"aspect-square object-contain"}
                      alt={product.name}
